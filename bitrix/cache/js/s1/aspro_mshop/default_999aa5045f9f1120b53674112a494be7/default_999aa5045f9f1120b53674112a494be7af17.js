...
; /* Start:"a:4:{s:4:"full";s:103:"/bitrix/templates/aspro_mshop/components/bitrix/catalog.section/catalog_block/script.js?146037190841978";s:6:"source";s:87:"/bitrix/templates/aspro_mshop/components/bitrix/catalog.section/catalog_block/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
(function (window) {
...
window.JCCatalogSection.prototype.ChangeInfo = function()
{
	...
	if (-1 < index){
		...
		$(this.obProduct).find('.hover_block .counter_wrapp').hide();
		$(this.obProduct).find('.hover_block .counter_wrapp').css('opacity','0');
		$(this.obProduct).find('.hover_block .o_'+this.offers[this.offerNum].ID).show('100', function(){
			$(this).css('opacity','1');
		});

		$(this.obProduct).find('.like_icons .wish_item_button').hide();
		$(this.obProduct).find('.like_icons .compare_item_button').hide();
		$(this.obProduct).find('.item_info  .view_sale_block.offers').hide();
		$(this.obProduct).find('.like_icons .o_'+this.offers[this.offerNum].ID).show();
		$(this.obProduct).find('.item_info  .view_sale_block.offers.o_'+this.offers[this.offerNum].ID).show();
		/*compareParams = {
			ajax_action: 'Y'
		};
		BX.ajax.loadJSON(
...
/* End */
;; /* /bitrix/templates/aspro_mshop/components/bitrix/catalog.section/catalog_block/script.js?146037190841978*/
