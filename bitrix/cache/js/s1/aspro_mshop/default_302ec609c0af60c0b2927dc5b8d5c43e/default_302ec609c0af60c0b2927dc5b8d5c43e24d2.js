...
; /* Start:"a:4:{s:4:"full";s:102:"/bitrix/templates/aspro_mshop/components/bitrix/catalog.section/catalog_list/script.js?146037190842043";s:6:"source";s:86:"/bitrix/templates/aspro_mshop/components/bitrix/catalog.section/catalog_list/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
(function (window) {
...
window.JCCatalogSection.prototype.ChangeInfo = function()
{
	...
	if (-1 < index){
		...
		if($(this.obProduct).find('.like_icons .o_'+this.offers[this.offerNum].ID).data("changed")!="Y"){
			BX.onCustomEvent('onCatalogCompareChange', [this.offers[this.offerNum].ID, this.obProduct]);
		}
		if($(this.obProduct).find('.hover_block .o_'+this.offers[this.offerNum].ID).data("changed")!="Y"){
			BX.onCustomEvent('onCatalogBasketChange', [this.offers[this.offerNum].ID, this.obProduct]);
		}
		$(this.obProduct).find('.information .counter_wrapp').hide();
		$(this.obProduct).find('.information .counter_wrapp').css('opacity','0');
		$(this.obProduct).find('.information .o_'+this.offers[this.offerNum].ID).show('100', function(){
			$(this).css('opacity','1');
		});


		$(this.obProduct).find('.like_icons .wish_item_button').hide();
		$(this.obProduct).find('.like_icons .compare_item_button').hide();
		$(this.obProduct).find('.information  .view_sale_block.offers').hide();
		$(this.obProduct).find('.like_icons .o_'+this.offers[this.offerNum].ID).show();
		$(this.obProduct).find('.information  .view_sale_block.offers.o_'+this.offers[this.offerNum].ID).show();
		/*compareParams = {
			ajax_action: 'Y'
		};
		BX.ajax.loadJSON(
...
/* End */
;; /* /bitrix/templates/aspro_mshop/components/bitrix/catalog.section/catalog_list/script.js?146037190842043*/
